...
const Timeline = () => {
  ...
  const milestones = [
    { year: "2007", event: "Company Conceptualized", phase: "Foundation & Setup" },
    { year: "2008-10", event: "Initial Growth", phase: "Building Capabilities" },
    { year: "2011-15", event: "Expansion Phase", phase: "Market Expansion" },
    { year: "2016-20", event: "Rapid Growth", phase: "Technology Upgrade" },
    { year: "2021-25", event: "Industry Leader", phase: "Global Partnerships" },
  ];
