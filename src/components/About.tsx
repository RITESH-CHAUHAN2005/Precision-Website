...
import { Calendar, Award, Weight, Building } from "lucide-react";
import teamImg from "@/assets/team.jpg";


const About = () => {
  const [isVisible, setIsVisible] = useState(false);
  const [counts, setCounts] = useState({ year: 0, clients: 0, production: 0, units: 0 });
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          animateCounter("clients", 50, 1500);
  ...
  const stats = [
    ...
    { icon: Award, value: counts.clients, label: "Global Clients", suffix: "+", prefix: "" },
          ...
          >
            ...
            <div className="mt-12">
              <p className="font-inter text-lg text-muted-foreground leading-relaxed mb-6">
                ...
                we combine <strong className="text-foreground">advanced manufacturing capabilities</strong> with cutting-edge technology and
              ...
              <p className="font-inter text-lg text-muted-foreground leading-relaxed">
                ...
                a trusted supplier to global industry leaders including FLSmidth, Metso, Tenneco, Valmet, Fuller Technologies, and Keestrack.
              </p>
            </div>
