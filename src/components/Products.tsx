...
const Products = () => {
  ...
  const products = [
    ...
    { 
      name: "Shafts", 
      image: products2,
      link: "/products/slurry-pump-solutions"
    },
    { 
    ...
    { 
      name: "Pump Casting", 
      image: machining,
      link: "/products/filter-press-systems"
    },
    { 
      name: "Fabrication", 
      image: facility,
    ...
    { 
      name: "Disc Filters", 
      image: assembly,
      link: "/products/disc-filter-components"
    },
    { 
      name: "Hydro Cyclones", 
      image: products1,
      link: "/products/hydro-cyclones"
    },
    { 
      name: "Railway & Mining", 
      image: products2,
      link: "/products/railway-mining-equipment"
    },
  ];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product, index) => (
            <Link
              key={index}
              to={product.link}
              className={`group relative overflow-hidden rounded-2xl bg-white shadow-lg card-lift transition-all duration-500 block ${
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 opacity-0 group-hover:opacity-100 transition-all duration-300">
                <div className="flex items-center gap-2 text-accent transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                  <span className="font-inter text-sm text-white">Learn More</span>
